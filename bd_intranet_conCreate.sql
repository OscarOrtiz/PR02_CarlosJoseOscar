...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2015 a las 08:49:22
...
--
CREATE DATABASE IF NOT EXISTS `bd_intranet` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `bd_intranet`;
...
CREATE TABLE IF NOT EXISTS `estadoinfo` (
  ...
  `nomEstadp` varchar(20) COLLATE utf8_bin NOT NULL
...
INSERT INTO `estadoinfo` (`idEstado`, `nomEstadp`) VALUES
(1, 'Disponible'),
(2, 'No disponible'),
(3, 'En reparacion');
...
INSERT INTO `users` (`idUser`, `nomUser`, `mail`, `telf`, `password`) VALUES
(1, 'Carlos Sanchez', 'carlos@intranet.es', 666554422, 'carsan'),
(2, 'Oscar Ortiz', 'oscar@intranet.es', 999887733, 'oscort'),
(3, 'Jose Luis Maseda', 'joseluis@intranet.es', 777332211, 'josmas'),
(4, 'Enric Gorriz', 'enric@intranet.es', 888775544, 'enrgor'),
(5, 'Alejandro Moreno', 'alejandro@intranet.es', 444553366, 'alemor');
...
--
ALTER TABLE `estadoinfo`
  MODIFY `idEstado` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `resources`
  MODIFY `idResource` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT de la tabla `resourcestype`
--
ALTER TABLE `resourcestype`
  MODIFY `idRType` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
